...
def _resid_subplot_CP(spec_type, system, panel, plot_index, ylab, percent_limits, df_sys, df_sys_unc, df_sys_unc_FRM, df_R ,bands):
    ''' suplot routine for residuals'''  
    colors = cm.rainbow(np.linspace(0,1,301)) 
...
def FRM_unc_plot(df_unc_PML_Ed, df_unc_NASA_Ed, df_unc_TARTU_Ed, df_unc_HEREON_Ed,
    ...
    subtitle  = ''
    index = 14
    _unc_subplot_FRM(subtitle, 'N.', index, ylab, 15, df_unc_TARTU_Rrs,bands)

    subtitle  = ''
    index = 15
    _unc_subplot_FRM(subtitle, 'O.', index, ylab, 15, df_unc_HEREON_Rrs ,bands)

    subtitle  = ''
    index = 16
    _unc_subplot_FRM(subtitle, 'P.', index, ylab, 15, df_unc_NASA_Rrs,bands)
...
def FRM_rad_diffplot(df_PML_Ed, df_NASA_Ed, df_TARTU_Ed, df_HEREON_Ed,
                     ...
                     bands, path_output, Q_mask, Qtype = 'QC_AOC_3'):
                #"Plot for Class- FRM % differences %
    ...
    plt.rc('font',size=18)  
    ylab = 'Percentage difference in radiometric quantities: 200*(Class $-$ FRM)/(Class + FRM) [%]'
    xlab = 'Wavelength [nm]'     
    ...
    index = 1
    _rad_subplot_FRM(subtitle, 'A.', index, ylab, 8, df_PML_Ed ,bands)
  
    subtitle  = 'RAMSES-A: N = ' + str(np.sum(~np.isnan(df_TARTU_Ed['400'])))
    index = 2
    _rad_subplot_FRM(subtitle, 'B.', index, ylab, 8, df_TARTU_Ed ,bands)

    subtitle  = 'RAMSES-B: N = ' + str(np.sum(~np.isnan(df_HEREON_Ed['400'])))
    index = 3
    _rad_subplot_FRM(subtitle, 'C.', index, ylab, 8, df_HEREON_Ed ,bands)

    subtitle  = 'pySAS: N = '  + str(np.sum(~np.isnan(df_NASA_Ed['400']))) + ' (' + str(np.sum(~np.isnan(df_NASA_Lsky['400']))) +')'        
    index = 4
    _rad_subplot_FRM(subtitle, 'D.', index, ylab, 8, df_NASA_Ed,bands )
    ...
    subtitle  = ''
    index = 6
    _rad_subplot_FRM(subtitle, 'F.', index, ylab, 8, df_TARTU_Lsky,bands)

    subtitle  = ''
    index = 7
    _rad_subplot_FRM(subtitle, 'G.', index, ylab, 8, df_HEREON_Lsky ,bands)

    subtitle  = ''
    index = 8
    _rad_subplot_FRM(subtitle, 'H.', index, ylab, 8, df_NASA_Lsky,bands)
    ...
    subtitle  = ''
    index = 10
    _rad_subplot_FRM(subtitle, 'J.', index, ylab, 8, df_TARTU_Lt,bands)

    subtitle  = ''
    index = 11
    _rad_subplot_FRM(subtitle, 'K.', index, ylab, 8, df_HEREON_Lt, bands)

    subtitle  = ''
    index = 12
    _rad_subplot_FRM(subtitle, 'L.', index, ylab, 8, df_NASA_Lt, bands)
    
    
    index = 13
    subtitle  = ''
    _rad_subplot_FRM(subtitle, 'M.', index, ylab, 8, df_PML_Rrs ,bands)
  
    subtitle  = ''
    index = 14
    _rad_subplot_FRM(subtitle, 'N.', index, ylab, 8, df_TARTU_Rrs,bands)

    subtitle  = ''
    index = 15
    _rad_subplot_FRM(subtitle, 'O.', index, ylab, 8, df_HEREON_Rrs ,bands)

    subtitle  = ''
    index = 16
    _rad_subplot_FRM(subtitle, 'P.', index, ylab, 8, df_NASA_Rrs,bands)
    
    
    plt.tight_layout(pad=1.2)
    
    
    filename  =  path_output +  '/' +  'Class_FRM_raddiff.png' 
    plt.savefig(filename, dpi=300)
...
def FRM_uncdiff_plot(df_unc_PML_Ed, df_unc_NASA_Ed, df_unc_TARTU_Ed, df_unc_HEREON_Ed,
                           ...
                           df_unc_PML_Rrs, df_unc_NASA_Rrs, df_unc_TARTU_Rrs, df_unc_HEREON_Rrs,
                           bands, path_output, Q_mask, Qtype = 'QC_AOC_3'):
    "Plot for FRM uncertainty distributions"
    ...
    plt.rc('font',size=18)  
    ylab = 'Uncertainty difference: Class $-$ FRM [%]'
    xlab = 'Wavelength [nm]'     
    ...
    subtitle  = 'RAMSES-A: N = ' + str(np.sum(~np.isnan(df_unc_TARTU_Ed['400'])))
    index = 2
    _unc_subplot_FRM(subtitle, 'B.', index, ylab, 5, df_unc_PML_Ed ,bands)

    subtitle  = 'RAMSES-B: N = ' + str(np.sum(~np.isnan(df_unc_HEREON_Ed['400'])))
    index = 3
    _unc_subplot_FRM(subtitle, 'C.', index, ylab, 5, df_unc_HEREON_Ed ,bands)

    subtitle  = 'pySAS: N = '  + str(np.sum(~np.isnan(df_unc_NASA_Ed['400']))) + ' (' + str(np.sum(~np.isnan(df_unc_NASA_Lsky['400']))) +')'        
    index = 4
    _unc_subplot_FRM(subtitle, 'D.', index, ylab, 5, df_unc_NASA_Ed,bands )
    ...
    subtitle  = ''
    index = 6
    _unc_subplot_FRM(subtitle, 'F.', index, ylab, 3, df_unc_TARTU_Lsky,bands)

    subtitle  = ''
    index = 7
    _unc_subplot_FRM(subtitle, 'G.', index, ylab, 3, df_unc_HEREON_Lsky ,bands)

    subtitle  = ''
    index = 8
    _unc_subplot_FRM(subtitle, 'H.', index, ylab, 3, df_unc_NASA_Lsky,bands)
    ...
    index = 13
    subtitle  = ''
    _unc_subplot_FRM_V2(subtitle, 'M.', index, ylab, 6, df_unc_PML_Rrs ,bands)
  
    subtitle  = ''
    index = 14
    _unc_subplot_FRM_V2(subtitle, 'N.', index, ylab, 6, df_unc_TARTU_Rrs,bands)

    subtitle  = ''
    index = 15
    _unc_subplot_FRM_V2(subtitle, 'O.', index, ylab, 6, df_unc_HEREON_Rrs ,bands)

    subtitle  = ''
    index = 16
    _unc_subplot_FRM_V2(subtitle, 'P.', index, ylab,6, df_unc_NASA_Rrs,bands)
...
def FRM_uncdiffV2_plot(df_unc_PML_Ed, df_unc_NASA_Ed, df_unc_TARTU_Ed, df_unc_HEREON_Ed,
    ...
    plt.rc('font',size=18)  
    ylab = 'Uncertainty difference: 200(Class - FRM)/(Class + FRM)  [%]'
    xlab = 'Wavelength [nm]'     
    ...
    subtitle  = 'RAMSES-A: N = ' + str(np.sum(~np.isnan(df_unc_TARTU_Ed['400'])))
    index = 2
    _unc_subplot_FRM(subtitle, 'B.', index, ylab, 140, df_unc_PML_Ed ,bands)

    subtitle  = 'RAMSES-B: N = ' + str(np.sum(~np.isnan(df_unc_HEREON_Ed['400'])))
    index = 3
    _unc_subplot_FRM(subtitle, 'C.', index, ylab, 140, df_unc_HEREON_Ed ,bands)

    subtitle  = 'pySAS: N = '  + str(np.sum(~np.isnan(df_unc_NASA_Ed['400']))) + ' (' + str(np.sum(~np.isnan(df_unc_NASA_Lsky['400']))) +')'        
    index = 4
    _unc_subplot_FRM(subtitle, 'D.', index, ylab, 140, df_unc_NASA_Ed,bands )
    ...
    subtitle  = ''
    index = 6
    _unc_subplot_FRM(subtitle, 'F.', index, ylab, 100, df_unc_TARTU_Lsky,bands)

    subtitle  = ''
    index = 7
    _unc_subplot_FRM(subtitle, 'G.', index, ylab, 100, df_unc_HEREON_Lsky ,bands)

    subtitle  = ''
    index = 8
    _unc_subplot_FRM(subtitle, 'H.', index, ylab, 100, df_unc_NASA_Lsky,bands)
    ...
    subtitle  = ''
    index = 10
    _unc_subplot_FRM(subtitle, 'J.', index, ylab, 100, df_unc_TARTU_Lt,bands)

    subtitle  = ''
    index = 11
    _unc_subplot_FRM(subtitle, 'K.', index, ylab, 100, df_unc_HEREON_Lt ,bands)

    subtitle  = ''
    index = 12
    _unc_subplot_FRM(subtitle, 'L.', index, ylab, 100, df_unc_NASA_Lt,bands)
    ...
    subtitle  = ''
    index = 14
    _unc_subplot_FRM_V3(subtitle, 'N.', index, ylab, 100, df_unc_TARTU_Rrs,bands)

    subtitle  = ''
    index = 15
    _unc_subplot_FRM_V3(subtitle, 'O.', index, ylab, 100, df_unc_HEREON_Rrs ,bands)

    subtitle  = ''
    index = 16
    _unc_subplot_FRM_V3(subtitle, 'P.', index, ylab,100, df_unc_NASA_Rrs,bands)
...
def residuals_combined_V3(spec_type, df_R_CP, df_PML_CP, df_NASA_CP, df_TARTU_CP, df_HEREON_CP, 
                          df_R_CP_FRM, df_PML_CP_FRM, df_NASA_CP_FRM, df_TARTU_CP_FRM, df_HEREON_CP_FRM, 
                          df_PML, df_NASA, df_TARTU, df_HEREON, 
                          df_PML_diff, df_NASA_diff, df_TARTU_diff, df_HEREON_diff, 
                          df_unc_PML, df_unc_NASA, df_unc_TARTU, df_unc_HEREON, 
                          df_unc_PML_FRM, df_unc_NASA_FRM, df_unc_TARTU_FRM, df_unc_HEREON_FRM, 
                          df_uncdiff_PML, df_uncdiff_NASA, df_uncdiff_TARTU, df_uncdiff_HEREON, 
                          bands, path_output, Q_mask, Qtype = 'QC_AOC_3'):
    ...
    df_PML_CP_FRM = df_PML_CP_FRM[Q_mask[Qtype]==1]
    df_NASA_CP_FRM = df_NASA_CP_FRM[Q_mask[Qtype]==1]
    df_TARTU_CP_FRM = df_TARTU_CP_FRM[Q_mask[Qtype]==1]
    df_HEREON_CP_FRM = df_HEREON_CP_FRM[Q_mask[Qtype]==1]
   ...
   # ylab = 'HCP Class baseline residual: \n 100($X_{HCP}$ - $X_{R}$)/$X_{R}$  [%]'
    ...
    subtitle  = 'pySAS: N = ' + str(np.sum(~np.isnan(df_NASA_CP['400'])))
    index = 2
    _resid_subplot_CP(spec_type, subtitle,'B.', index, ylab, percent_limits, df_NASA_CP, unc_med_NASA, unc_med_NASA_FRM, df_R_CP, bands)

    subtitle  = 'RAMSES-A: N = ' + str(np.sum(~np.isnan(df_TARTU_CP['400'])))
    index = 3
    _resid_subplot_CP(spec_type,subtitle, 'C.', index, ylab, percent_limits, df_TARTU_CP, unc_med_TARTU, unc_med_TARTU_FRM, df_R_CP, bands)

    subtitle  = 'RAMSES-B: N = ' + str(np.sum(~np.isnan(df_HEREON_CP['400'])))
    index = 4
    _resid_subplot_CP(spec_type,subtitle, 'D.', index, ylab,percent_limits, df_HEREON_CP, unc_med_HEREON,  unc_med_HEREON_FRM, df_R_CP, bands)
  ...
  #  subtitle  = 'NASA: N = ' + str(np.sum(~np.isnan(df_NASA['560'])))
    index = 6
    _unc_subplot_CP(spec_type, subtitle,'F.', index, ylab, percent_limits, df_unc_NASA, bands)
    
# subtitle  = 'TARTU: N = ' + str(np.sum(~np.isnan(df_TARTU['560'])))
    index = 7
    _unc_subplot_CP(spec_type,subtitle, 'G.', index, ylab, percent_limits, df_unc_TARTU,bands)

   # subtitle  = 'HEREON: N = ' + str(np.sum(~np.isnan(df_HEREON['560'])))
    index = 8
    _unc_subplot_CP(spec_type,subtitle, 'H.', index, ylab,percent_limits, df_unc_HEREON,bands)

    
    plt.rc('font',size=16)  
   # ylab = 'HCP Class baseline residual: \n 100($X_{HCP}$ - $X_{R}$)/$X_{R}$  [%]'
    ylab = 'HCP Sensor residual: \n 100($X_{HCP}$ - $X_{R}$)/$X_{R}$  [%]'
    if spec_type == 'Ed':
        percent_limits = 8
    if spec_type == 'Lsky':
         percent_limits = 8
   ...
   # subtitle  = 'HyperSAS: N = ' + str(np.sum(~np.isnan(df_PML_CP['400'])))
    index = 9
    _resid_subplot_CP_FRM(spec_type, subtitle, 'I.', index, ylab, percent_limits, df_PML_CP_FRM, unc_med_PML, unc_med_PML_FRM, df_R_CP_FRM, bands)
  
  #  subtitle  = 'pySAS: N = ' + str(np.sum(~np.isnan(df_NASA_CP['400'])))
    index = 10
    _resid_subplot_CP_FRM(spec_type, subtitle,'J.', index, ylab, percent_limits, df_NASA_CP_FRM, unc_med_NASA, unc_med_NASA_FRM, df_R_CP_FRM, bands)

  #  subtitle  = 'RAMSES-A: N = ' + str(np.sum(~np.isnan(df_TARTU_CP['400'])))
    index = 11
    _resid_subplot_CP_FRM(spec_type,subtitle, 'K.', index, ylab, percent_limits, df_TARTU_CP_FRM, unc_med_TARTU, unc_med_TARTU_FRM, df_R_CP_FRM, bands)

  #  subtitle  = 'RAMSES-B: N = ' + str(np.sum(~np.isnan(df_HEREON_CP['400'])))
    index = 12
    _resid_subplot_CP_FRM(spec_type,subtitle, 'L.', index, ylab,percent_limits, df_HEREON_CP_FRM, unc_med_HEREON,  unc_med_HEREON_FRM, df_R_CP_FRM, bands)
  ...
  #  subtitle  = 'PML: N = ' + str(np.sum(~np.isnan(df_PML['560'])))
    index = 13
    _unc_subplot_CP_FRM(spec_type, subtitle,'M.',  index, ylab, percent_limits, df_unc_PML_FRM,bands)
      
  #  subtitle  = 'NASA: N = ' + str(np.sum(~np.isnan(df_NASA['560'])))
    index = 14
    _unc_subplot_CP_FRM(spec_type, subtitle,'N.', index, ylab, percent_limits, df_unc_NASA_FRM, bands)
    
   # subtitle  = 'TARTU: N = ' + str(np.sum(~np.isnan(df_TARTU['560'])))
    index = 15
    _unc_subplot_CP_FRM(spec_type, subtitle,'O.', index, ylab, percent_limits, df_unc_TARTU_FRM,bands)

   # subtitle  = 'HEREON: N = ' + str(np.sum(~np.isnan(df_HEREON['560'])))
    index = 16
    _unc_subplot_CP_FRM(spec_type, subtitle,'P', index, ylab,percent_limits, df_unc_HEREON_FRM,bands)



    ylab = 'Difference: \n' + r' 100$\frac{(Class - Sensor)}{(Sensor)}$ [%]'
    xlab = 'Wavelength [nm]'   
    ...
    index = 17
    _uncdiff_subplot(spec_type,subtitle, 'Q.', index, ylab, percent_limits, df_PML_diff, bands)
   
    index = 18
    _uncdiff_subplot(spec_type,subtitle, 'R.', index, ylab, percent_limits, df_NASA_diff, bands)
    
    index = 19
    _uncdiff_subplot(spec_type,subtitle, 'S.', index, ylab, percent_limits, df_TARTU_diff, bands)
    
    index = 20
    _uncdiff_subplot(spec_type,subtitle, 'T.', index, ylab, percent_limits, df_HEREON_diff, bands)
    ...
    index = 21
    _uncdiff_subplot(spec_type,subtitle, 'U.', index, ylab, percent_limits, df_uncdiff_PML ,bands)
   
    index = 22
    _uncdiff_subplot(spec_type,subtitle, 'V.', index, ylab, percent_limits, df_uncdiff_NASA ,bands)
    
    index = 23
    _uncdiff_subplot(spec_type,subtitle, 'W.', index, ylab, percent_limits, df_uncdiff_TARTU ,bands)
    
    index = 24
    _uncdiff_subplot(spec_type,subtitle, 'X.', index, ylab, percent_limits, df_uncdiff_HEREON ,bands)
    ...
    subtitle  = 'PML: N = ' + str(np.sum(~np.isnan(df_PML_CP['400'])))
    index = 25
    _resid_subplot_CP_IP(spec_type, subtitle,'Y.', index, ylab, percent_limits, df_PML, df_PML_CP,bands)


    subtitle  = 'TARTU: N = ' + str(np.sum(~np.isnan(df_TARTU_CP['400'])))
    index = 26
    _resid_subplot_CP_IP(spec_type,subtitle, 'Z.',index, ylab, percent_limits, df_TARTU, df_TARTU_CP ,bands)

   # subtitle  = 'HEREON: N = ' + str(np.sum(~np.isnan(df_HEREON_CP['400'])))
    index = 27
    _resid_subplot_CP_IP(spec_type,subtitle, 'AA.', index, ylab,percent_limits, df_HEREON, df_HEREON_CP ,bands)
    
   # subtitle  = 'NASA: N = ' + str(np.sum(~np.isnan(df_NASA_CP['400'])))
    index = 28
    _resid_subplot_CP_IP(spec_type, subtitle,'BB.', index, ylab, percent_limits, df_NASA, df_NASA_CP ,bands)
